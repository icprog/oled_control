...
#define		LCD_SCLK_IO					GPIO_Pin_4					 //SCLK  Ê±ÖÓ D0£¨SCLK£©
#define		LCD_SCLK_PORT				GPIOA
#define   LCD_SCLK_RCC				RCC_APB2Periph_GPIOA
#define		LCD_SDA_IO					GPIO_Pin_5					 //SDA   D1£¨MOSI£© Êý¾Ý
#define		LCD_SDA_PORT				GPIOA
#define   LCD_SDA_RCC					RCC_APB2Periph_GPIOA
#define		LCD_RST_IO					GPIO_Pin_6					//_RES  hardware reset   ¸´Î» 
#define		LCD_RST_PORT				GPIOA
#define   LCD_RST_RCC					RCC_APB2Periph_GPIOA
#define		LCD_DC_IO						GPIO_Pin_7				 //A0  H/L ÃüÁîÊý¾ÝÑ¡Í¨¶Ë£¬H£ºÊý¾Ý£¬L:ÃüÁî
#define		LCD_DC_PORT					GPIOA
#define   LCD_DC_RCC					RCC_APB2Periph_GPIOA
#define		LCD_CS_IO						GPIO_Pin_8				 //OLEDÆ¬Ñ¡ÐÅºÅ
#define		LCD_CS_PORT					GPIOA
#define   LCD_CS_RCC					RCC_APB2Periph_GPIOA

#define		ROM_CS_IO						GPIO_Pin_6				 //romÆ¬Ñ¡ÐÅºÅ
